function [ligand_final] = DioP_anchor_vf_water(ligand,Grid_Heatmap,pocket_centroid,protein,water_mat,protein_centroidA)
            ...
            for gb1=1:size(grid_bin1,1)
                ...
                %for gb2 = 13:13
                    ...
                    for rotnum=1:24
                        ...
                        [protein_starterA_X1,protein_starterB_X1,repulse_num_X1] = pocket2find_PL_Dock(protein_score,ligand_rot(rotnum).structure,RcutoffPL);
