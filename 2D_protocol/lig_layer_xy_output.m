%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function out = lig_layer_xy_output(input_struc,list,lyr1,lyr2,asdf,output_dir)
...
fid=fopen(strcat(output_dir,'\',list,'_',num2str(lyr1),'_',num2str(lyr2),'_',num2str(asdf),'.xyz'),'wt');
